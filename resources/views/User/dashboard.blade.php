        ...
        <div class="page-content">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                    ...
                    <div class="card radius-10 bg-gradient-deepblue">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 text-white">{{$count = \App\Form::where([['creator', '=', Auth::user()->name]])->count()}}</h5>
                                <div class="ms-auto">
                                    <i class='bx bx-calculator fs-3 text-white'></i>
                                </div>
                            </div>
                ...
                <div class="col">
                    ...
                    @if( \App\Form::where('Is_approve', '=', 0)->count()==0)
                        ...
                        <div class="card radius-10 bg-gradient-ohhappiness">
                            ...
                            @else
                                <div class="card radius-10 bg-gradient-orange">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <h5 class="mb-0 text-white">{{$count = \App\Form::where('Is_approve', '=', 0)->count()}}</h5>
                                            <div class="ms-auto">
                                        ...
                                        <div class="d-flex align-items-center text-white">
                                            ...
                                            <p class="mb-0 ms-auto">+1.2%<span><i
                        ...
                        <div class="col">
                            <div class="card radius-10 bg-gradient-ohhappiness">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <h5 class="mb-0 text-white">{{$count = \App\Report::where([['creator', '=', Auth::user()->name]])->count()}}</h5>
                                        <div class="ms-auto">
                                    ...
                                    <div class="d-flex align-items-center text-white">
                                        ...
                                        <p class="mb-0 ms-auto">+5.2%<span><i
                                                    class='bx bx-up-arrow-alt'></i></span></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card radius-10 bg-gradient-ibiza">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center text-white">
                                        ...
                                        <p class="mb-0 ms-auto">+2.2%<span><i
                                                    class='bx bx-up-arrow-alt'></i></span></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
                                                        <span class="border px-1 rounded cursor-pointer"><i
                                                                class="bx bxs-circle me-1" style="color: #14abef"></i>New Visitor</span>
                                    <span class="border px-1 rounded cursor-pointer"><i
                                            class="bx bxs-circle me-1" style="color: #ade2f9"></i>Old Visitor</span>
                                </div>
                        ...
                        <div class="card radius-10 overflow-hidden w-100">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center mb-0">
                                    <tbody>
                                    <tr>
                                        <td><i class="bx bxs-circle me-2"
                                               style="color: #14abef"></i> Direct
                                        </td>
                                        <td>$5856</td>
                                        <td>+66%</td>
                                    </tr>
                                    <tr>
                                        <td><i class="bx bxs-circle me-2"
                                               style="color: #02ba5a"></i>Affiliate
                                        </td>
                                        <td>$2602</td>
                                        <td>+25%</td>
                                    </tr>
                ...
                <div class="row row-cols-1 row-cols-lg-3">
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="w_chart easy-dash-chart1"
                                         data-percent="{{$count = \App\User::all()->count()+50}}">
                                        <span class="w_percent"></span>
                                    </div>
                                    <div class="ms-3">
                                        <h6 class="mb-0">Facebook Followers</h6>
                                        <small class="mb-0">22.14% <i
                                                class='bx bxs-up-arrow align-middle me-1'></i>Since
                                            Last Week</small>
                                    </div>
                                    <div class="ms-auto fs-1 text-facebook"><i
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="w_chart easy-dash-chart2"
                                         data-percent="{{$count = \App\User::all()->count()+40}}">
                                        <span class="w_percent"></span>
                                    </div>
                                    <div class="ms-3">
                                    ...
                                    <div class="ms-auto fs-1 text-twitter"><i
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="w_chart easy-dash-chart3"
                                         data-percent="{{$count = \App\User::all()->count()+30}}">
                                        <span class="w_percent"></span>
                                    </div>
                                    <div class="ms-3">
                                    ...
                                    <div class="ms-auto fs-1 text-youtube"><i
